...
<<<<<<< HEAD
        ...
        private static class Odometry {
                /**  */
                static final float ksVolts = 0;
                /**  */
                static final float kvVoltSecondsPerMeter = 0;
                /**  */
                static final float kaVoltSecondsSquaredPerMeter = 0;
                /**  */
                static final float kMaxSpeedMetersPerSecond = 0;
                /**  */
                static final float kMaxAccelerationMetersPerSecondSquared = 0;
                /**  */
                static final float ksVolts = 0;
...
>>>>>>> d6ac79ebca4ac37bc5457120d107765deb08cebd
        ...
        public static final SwerveModule frontLeftModule = Mk4SwerveModuleHelper.createFalcon500(
                        tab.getLayout("Front Left Module", BuiltInLayouts.kList)
                                        .withSize(2, 4)
                                        .withPosition(0, 0),
                        DRIVE_RATIO, CANID.FL_DRIVE_FALCON, CANID.FL_STEER_FALCON, CANID.FL_STEER_ENCODER,
        ...
        public static final SwerveModule frontRightModule = Mk4SwerveModuleHelper.createFalcon500(
                        tab.getLayout("Front right Module", BuiltInLayouts.kList)
                                        .withSize(2, 4)
                                        .withPosition(2, 0),
                        DRIVE_RATIO, CANID.FR_DRIVE_FALCON, CANID.FR_STEER_FALCON, CANID.FR_STEER_ENCODER,
        ...
        public static final SwerveModule backLeftModule = Mk4SwerveModuleHelper.createFalcon500(
                        tab.getLayout("Back Left Module", BuiltInLayouts.kList)
                                        .withSize(2, 4)
                                        .withPosition(4, 0),
                        DRIVE_RATIO, CANID.BL_DRIVE_FALCON, CANID.BL_STEER_FALCON, CANID.BL_STEER_ENCODER,
        ...
        public static final SwerveModule backRightModule = Mk4SwerveModuleHelper.createFalcon500(
                        tab.getLayout("Back Right Module", BuiltInLayouts.kList)
                                        .withSize(2, 4)
                                        .withPosition(6, 0),
                        DRIVE_RATIO, CANID.BR_DRIVE_FALCON, CANID.BR_STEER_FALCON, CANID.BR_STEER_ENCODER,
